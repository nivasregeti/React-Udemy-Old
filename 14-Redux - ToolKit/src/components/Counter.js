...
const Counter = () => {
  ...
  const toggleCounterHandler = () => {
    dispatch(counterActions.toggleCounter()); //returns an action object of this shape: {type: 'some auto-generated unique identifier'}
    //triggers the toggleCounter method in reducers
  };
